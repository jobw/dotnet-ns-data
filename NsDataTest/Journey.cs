...
namespace NsDataTest
{
    ...
    {
        public Journey(uint id, List<TrainJourney> trainJourneys, FootNote footNote, ushort footNoteStartStop, ushort footNoteStopStop, List<TransitType> transitTypes, List<JourneyAttribute> journeyAttributes, List<Stop> stops) 
        {
            Id = id;
        ...
        private readonly static Dictionary<uint, Journey> _Journeys = new Dictionary<uint, Journey>();
        public static Dictionary<uint, Journey> AllJourneys { get { return _Journeys; } }
        static Journey()
        {
                            ...
                            if (line.StartsWith(">")) 
                            {
                                ...
                                if (line.StartsWith("<"))
                                {
                                    ...
                                    if (line.StartsWith("?"))
                                    {
                                        ...
                                        line = sr.ReadLine();
                                        if (line == null) throw new Exception("damn");
                                    }
                                    else
        ...
        public static bool TryGetJourneysFromInitialDepartureTime(TimeOnly time, out List<Journey> journeys, DateOnly? onDate = null)
        {
            ...
            if (_foundJourneys.Count > 1)
                return true; 
            return false;
        }

        public static bool TryGetJourneysFromDepartureTime(TimeOnly time, out Dictionary<Stop, Journey> departures, DateOnly? onDate = null)
        {
